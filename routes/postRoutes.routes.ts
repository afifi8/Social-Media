...
// Pass io to likeToPost and unLikedPost controller functions
router.patch("/likeToPost/:id", (req, res, next) => {
  // Assume `io` is available via `req.app.get('io')`
  const io = req.app.get("io"); // Ensure you set io on app instance
